...
- **C2** `reports.py`·`control_catalog.py`·`soa.py`·routes(`sources.py:230`, `compliance.py:1553/1012`, `accounts_gov.py:387`, `incidents.py:63`)의 손수 CSV를 `render_csv`/`csv_text_response`로. **사용자 입력(계정명·findings) 미방어 = 실인젝션 갭.**
