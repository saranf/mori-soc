...
| 📚 | **통제 카탈로그** | ISMS-P 101 + ISO 27001:2022 93 = **194 인증기준**(한/영) 트리 + 이행상태 편집·영속 + **admin 직접 편집(추가/수정/삭제)** + **법령 텍스트 NLP 임포트**(Claude/휴리스틱) + **수기 증적 문서화** + 증적 팩 **CSV/PDF 선택 다운로드** |
...
휴리스틱). 통제별로 **수기 증적을 문서화**(제목·내용·수집자·수집일·참조링크)하고, 증적 팩은
라이브 증적과 합쳐 **CSV 또는 PDF**로 골라 내려받습니다. 편집은 admin 전용, 증적 문서화는 admin·security.
