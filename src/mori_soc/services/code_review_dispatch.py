  ...
  semgrep:
    ...
    steps:
      ...
      - uses: actions/setup-python@v5
        with:
          python-version: "3.12"
      - name: Semgrep scan (free OSS rules + MORI PII rules)
        env:
    ...
    steps:
      ...
      - name: Full-repo AI security review -> MORI
        ...
        run: |
          ...
          # 무결성 감사(#16): 받은 스캐너 sha256 + MORI 매니페스트를 로그에 남긴다(핀·대조용).
