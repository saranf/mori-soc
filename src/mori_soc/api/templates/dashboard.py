    ...
    <header class=\"topbar\">
      ...
      <div class=\"top-actions\">
        ...
        <div class=\"account-wrap\" style=\"position:relative\">
          <button id=\"account_btn\" type=\"button\" onclick=\"toggleAccountMenu()\" style=\"width:auto;background:#f7f8fa;border:1px solid #e5e8eb;color:#191f28;font-size:13px;font-weight:600;padding:6px 12px;border-radius:999px;cursor:pointer\"><span id=\"ui_user_badge\" data-i18n=\"dash.account.title\">계정</span></button>
          <div id=\"account_menu\" style=\"display:none;position:absolute;right:0;top:calc(100% + 6px);background:#f7f8fa;border:1px solid #e5e8eb;border-radius:10px;padding:12px;min-width:220px;z-index:9998;box-shadow:0 8px 24px rgba(0,0,0,0.45)\">
            <button type=\"button\" onclick=\"openProfileModal()\" style=\"display:block;width:100%;text-align:left;background:transparent;border:none;color:#191f28;font-size:13px;font-weight:600;padding:6px 4px;cursor:pointer\" data-i18n=\"dash.account.edit_profile\">프로필 편집</button>
            <button type=\"button\" onclick=\"shortcutMyServers()\" style=\"display:block;width:100%;text-align:left;background:transparent;border:none;color:#191f28;font-size:13px;font-weight:600;padding:6px 4px;cursor:pointer\" data-i18n=\"dash.account.my_servers\">내 서버</button>
            <a id=\"ui_admin_console_link\" href=\"/admin\" style=\"display:none;width:100%;text-align:left;color:#191f28;font-size:13px;font-weight:600;padding:6px 4px;text-decoration:none\" data-i18n=\"dash.account.admin_console\">관리자 콘솔</a>
            <div style=\"border-top:1px solid #e5e8eb;margin:10px 0\"></div>
            <div style=\"font-size:12px;color:#191f28;margin-bottom:6px\" data-i18n=\"dash.account.language\">언어 / Language</div>
            __I18N_TOGGLE__
            <div style=\"border-top:1px solid #e5e8eb;margin:10px 0\"></div>
...
__TAB_DASHBOARD____TAB_TRIAGE____TAB_INCIDENTS____TAB_ASSETS____TAB_COMPLIANCE____TAB_ACCOUNTS____TAB_GUIDES__  </div>
  ...
  <dialog id=\"overview_modal\">
    <div class=\"guide-dialog\">
      <div class=\"guide-dialog-head\">
        ...
        <form method=\"dialog\"><button type=\"submit\" style=\"padding:6px 16px;background:#f7f8fa;color:#3182f6;border:1px solid #e5e8eb;border-radius:999px;cursor:pointer;\" data-i18n=\"dash.f.close\">닫기</button></form>
      </div>
  ...
  <dialog id=\"info_modal\">
    <div class=\"guide-dialog\">
      <div class=\"guide-dialog-head\">
        ...
        <form method=\"dialog\"><button type=\"submit\" style=\"padding:6px 16px;background:#f7f8fa;color:#3182f6;border:1px solid #e5e8eb;border-radius:999px;cursor:pointer;\" data-i18n=\"dash.f.confirm\">확인</button></form>
      </div>
  ...
  <dialog id=\"triage_modal\">
    <div class=\"guide-dialog\">
      ...
      <div class=\"guide-dialog-copy\">
        ...
        <div class=\"row\"><label><span data-i18n=\"dash.f.analyst\">담당자</span> <span style=\"color:#191f28;font-size:11px\" data-i18n=\"dash.modal.analyst_default_hint\">(서버 담당자 기본)</span></label><input id=\"triage_modal_analyst\" placeholder=\"예: alice\" data-i18n-placeholder=\"dash.ph.alice\" /></div>
  ...
  <dialog id=\"incident_modal\">
    <div class=\"guide-dialog\">
      ...
      <div class=\"guide-dialog-copy\">
        <div id=\"incident_modal_info\" style=\"margin-bottom:12px;font-size:13px;color:#191f28\"></div>
        ...
        <hr style=\"border-color:#191f28;margin:12px 0\" />
        <div style=\"margin-bottom:8px;font-size:13px;font-weight:600;color:#15c47e\" data-i18n=\"dash.modal.notes_title\">조사 노트</div>
    ...
    <div style=\"background:#f7f8fa;border:1px solid #e5e8eb;border-radius:10px;padding:28px 32px;width:500px;max-width:95vw\">
      ...
      <div style=\"display:flex;flex-direction:column;gap:12px\">
        ...
        <div style=\"display:flex;gap:10px;justify-content:flex-end;margin-top:4px\">
          <button id=\"plan_modal_save\" style=\"background:#15c47e;border:none;color:#fff;padding:8px 20px;border-radius:6px;cursor:pointer;font-size:14px\" data-i18n=\"dash.f.save\">저장</button>
          <button onclick=\"closePlanModal()\" style=\"background:#e5e8eb;border:1px solid #e5e8eb;color:#191f28;padding:8px 20px;border-radius:6px;cursor:pointer;font-size:14px\" data-i18n=\"dash.f.cancel\">취소</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id=\"profile_modal\" class=\"modal-overlay\" style=\"z-index:9999\">
    <div style=\"background:#f7f8fa;border:1px solid #e5e8eb;border-radius:10px;padding:28px 32px;width:440px;max-width:95vw\">
      ...
      <div style=\"display:flex;flex-direction:column;gap:12px\">
        ...
        <div style=\"display:flex;gap:10px;justify-content:flex-end;margin-top:4px\">
          <button id=\"profile_modal_save\" onclick=\"saveProfile()\" style=\"background:#3182f6;border:none;color:#fff;padding:8px 20px;border-radius:6px;cursor:pointer;font-size:14px\" data-i18n=\"dash.profile.save\">저장</button>
          <button onclick=\"closeProfileModal()\" style=\"background:#e5e8eb;border:1px solid #e5e8eb;color:#191f28;padding:8px 20px;border-radius:6px;cursor:pointer;font-size:14px\" data-i18n=\"dash.profile.cancel\">취소</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id=\"owner_modal\" class=\"modal-overlay\" style=\"z-index:9999\">
    <div style=\"background:#f7f8fa;border:1px solid #e5e8eb;border-radius:10px;padding:28px 32px;width:440px;max-width:95vw\">
      ...
      <div style=\"display:flex;flex-direction:column;gap:12px\">
        ...
        <div style=\"display:flex;gap:10px;justify-content:flex-end;margin-top:4px\">
          <button id=\"owner_modal_save\" style=\"background:#3182f6;border:none;color:#fff;padding:8px 20px;border-radius:6px;cursor:pointer;font-size:14px\" data-i18n=\"dash.f.save\">저장</button>
          <button onclick=\"closeOwnerModal()\" style=\"background:#e5e8eb;border:1px solid #e5e8eb;color:#191f28;padding:8px 20px;border-radius:6px;cursor:pointer;font-size:14px\" data-i18n=\"dash.f.cancel\">취소</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id=\"vuln_plans_notice_modal\" class=\"modal-overlay\" style=\"z-index:9998\">
    <div style=\"background:#f7f8fa;border:1px solid #fef3d6;border-radius:10px;padding:28px 32px;width:480px;max-width:95vw\">
      ...
      <div style=\"display:flex;gap:10px;justify-content:flex-end\">
        <button onclick=\"closeVulnPlansNotice()\" style=\"background:#e5e8eb;border:1px solid #e5e8eb;color:#191f28;padding:8px 18px;border-radius:6px;cursor:pointer;font-size:13px\" data-i18n=\"dash.f.close\">닫기</button>
        <button id=\"vuln_plans_notice_open_list\" style=\"background:#e5e8eb;border:1px solid #e5e8eb;color:#3182f6;padding:8px 18px;border-radius:6px;cursor:pointer;font-size:13px;font-weight:600\" data-i18n=\"dash.modal.open_summary_tab\">합계 탭 열기</button>
      </div>
    </div>
  </div>
  ...
  <div id=\"incident_csv_notice_modal\" class=\"modal-overlay\" style=\"z-index:9998\">
    <div style=\"background:#f7f8fa;border:1px solid #fef3d6;border-radius:10px;padding:28px 32px;width:520px;max-width:95vw\">
      ...
      <div style=\"color:#191f28;font-size:13px;line-height:1.7;margin-bottom:18px\">
        ...
        <div style=\"color:#191f28\" data-i18n-html=\"dash.modal.incident_csv_desc_html\">각 인시던트는 <strong style=\"color:#3182f6\">변경 일자</strong>와 <strong style=\"color:#3182f6\">최신 내역</strong>(현재 상태 / 담당자 / 영향도 등)만 1행으로 표시됩니다.</div>
        <div style=\"color:#191f28;margin-top:10px;font-size:12px\" data-i18n-html=\"dash.modal.incident_csv_hint_html\">전체 변경 이력은 어드민 <strong>통합 이력 로그</strong> 페이지 또는 <code style=\"background:#e5e8eb;padding:1px 6px;border-radius:3px\">/incidents/{id}/history</code> API를 이용해 주세요.</div>
      </div>
      <div style=\"display:flex;gap:10px;justify-content:flex-end\">
        ...
        <button id=\"incident_csv_confirm_btn\" class=\"dl-pill\" data-i18n=\"dash.modal.download\">다운로드</button>
      </div>
    </div>
  </div>
  ...
  <div id=\"vuln_action_modal\" class=\"modal-overlay\" style=\"z-index:9999\">
    <div style=\"background:#f7f8fa;border:1px solid #e5e8eb;border-radius:10px;padding:24px 28px;width:520px;max-width:95vw\">
      ...
      <div id=\"vuln_action_modal_status\" style=\"font-size:13px;color:#191f28;margin-top:10px\"></div>
      <div style=\"display:flex;gap:8px;justify-content:flex-end;margin-top:12px\">
        <button id=\"vuln_action_modal_clear\" style=\"display:none;background:#fdecee;border:1px solid #fdecee;color:#f04452;padding:8px 14px;border-radius:6px;cursor:pointer;font-size:13px\" data-i18n=\"dash.modal.clear_exception\">예외 해제</button>
        <button id=\"vuln_action_modal_save\" style=\"background:#15c47e;border:none;color:#fff;padding:8px 20px;border-radius:6px;cursor:pointer;font-size:14px\" data-i18n=\"dash.f.save\">저장</button>
        <button onclick=\"closeVulnActionModal()\" style=\"background:#e5e8eb;border:1px solid #e5e8eb;color:#191f28;padding:8px 20px;border-radius:6px;cursor:pointer;font-size:14px\" data-i18n=\"dash.f.cancel\">취소</button>
      </div>
    </div>
  </div>
  ...
  <div id=\"risk_modal\" class=\"modal-overlay\" style=\"z-index:9999\">
    <div style=\"background:#f7f8fa;border:1px solid #e5e8eb;border-radius:10px;padding:24px 28px;width:560px;max-width:95vw;max-height:88vh;overflow-y:auto\">
      ...
      <div style=\"font-size:11px;color:#191f28;margin-bottom:12px;line-height:1.5\" data-i18n=\"dash.risk.basis_note\">산정 기준: 영향도(자산 중요도 상/중/하) × 발생가능성(취약점 심각도·Trivy CVSS 기반). ISMS-P 위험관리 / ISO 27001 6.1.2·8.8 방법론. 조직 DoA(수용가능 위험수준)에 맞춰 등급 조정 가능.</div>
      ...
      <div style=\"display:flex;gap:8px;justify-content:flex-end;margin-top:12px\">
        ...
        <button onclick=\"closeRiskModal()\" style=\"background:#e5e8eb;border:1px solid #e5e8eb;color:#191f28;padding:8px 20px;border-radius:6px;cursor:pointer;font-size:14px\" data-i18n=\"dash.f.cancel\">취소</button>
      </div>
    </div>
  </div>
  ...
  <dialog id=\"nlq_fab_dialog\" class=\"nlq-dialog\">
    <div class=\"nlq-dialog-body\">
      ...
      <div style=\"color:#191f28;font-size:13px;margin-bottom:10px\"><span data-i18n=\"dash.nlq.dialog_desc\">자연스럽게 질문하거나 예시 형식으로 입력하면 해석합니다.</span> <a href=\"#\" id=\"nlq_guide_link\" style=\"color:#3182f6;\" data-i18n=\"dash.nlq.guide_link\">가이드</a></div>
      <textarea id=\"nlq_textarea\" rows=\"3\" style=\"width:100%;box-sizing:border-box;background:#ffffff;color:#191f28;border:1px solid #e5e8eb;border-radius:8px;padding:10px;font-size:14px;resize:vertical;\" placeholder=\"예: 오프라인 호스트 보여줘 / 최근 24시간 wazuh high alert 요약\" data-i18n-placeholder=\"dash.nlq.textarea_ph\"></textarea>
      <div id=\"nlq_interpret_result\" style=\"margin:8px 0;color:#3182f6;font-size:13px;\"></div>
