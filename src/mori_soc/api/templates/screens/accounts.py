      ...
      <div class=\"layout\">
        <section class=\"card\">
          ...
          <div style=\"display:flex;gap:6px;flex-wrap:wrap;align-items:center;margin:10px 0\">
            <input id=\"acc_appr_user\" placeholder=\"username\" style=\"background:#f7f8fa;border:1px solid #e5e8eb;color:#191f28;border-radius:6px;padding:5px 10px;font-size:13px;width:120px\" />
            <select id=\"acc_appr_kind\" style=\"background:#f7f8fa;border:1px solid #e5e8eb;color:#191f28;border-radius:6px;padding:5px 8px;font-size:13px\"><option value=\"account\">account</option><option value=\"sudo\">sudo</option></select>
            <input id=\"acc_appr_host\" placeholder=\"host(비우면 전역)\" data-i18n-placeholder=\"dash.acc.appr_host_ph\" style=\"background:#f7f8fa;border:1px solid #e5e8eb;color:#191f28;border-radius:6px;padding:5px 10px;font-size:13px;width:130px\" />
            <input id=\"acc_appr_reason\" placeholder=\"승인 사유\" data-i18n-placeholder=\"dash.acc.appr_reason_ph\" style=\"background:#f7f8fa;border:1px solid #e5e8eb;color:#191f28;border-radius:6px;padding:5px 10px;font-size:13px;flex:1;min-width:120px\" />
        ...
        <section class=\"card\">
          ...
          <div style=\"display:flex;gap:6px;flex-wrap:wrap;align-items:center;margin:10px 0\">
            <input id=\"ip_search\" placeholder=\"호스트/IP 검색…\" data-i18n-placeholder=\"dash.acc.ip_search_ph\" oninput=\"renderAccIpList()\" style=\"background:#f7f8fa;border:1px solid #e5e8eb;color:#191f28;border-radius:6px;padding:5px 10px;font-size:13px;width:150px\" />
            <select id=\"ip_filter_team\" onchange=\"renderAccIpList()\" style=\"background:#f7f8fa;border:1px solid #e5e8eb;color:#191f28;border-radius:6px;padding:5px 8px;font-size:13px\"><option value=\"\" data-i18n=\"dash.acc.ip_allteam\">전체 팀</option></select>
            <select id=\"ip_filter_cat\" onchange=\"renderAccIpList()\" style=\"background:#f7f8fa;border:1px solid #e5e8eb;color:#191f28;border-radius:6px;padding:5px 8px;font-size:13px\"><option value=\"\" data-i18n=\"dash.acc.ip_allcat\">전체 용도</option></select>
