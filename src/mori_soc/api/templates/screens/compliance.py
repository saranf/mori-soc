...
_TAB_COMPLIANCE_HTML = """    <!-- ── Tab: 심사 준비 (Compliance PDCA) ──────────────────────────── -->
    <div class=\"tab-panel\" id=\"tab_compliance\">
      ...
      <section class=\"card\" id=\"pdca_hero\">
        <div style=\"display:flex;align-items:center;gap:24px;flex-wrap:wrap\">
          ...
          <div style=\"flex:1;min-width:240px\">
            ...
            <div class=\"subtext\" id=\"pdca_hero_headline\" style=\"margin:4px 0 0;font-weight:600;color:#191f28\"></div>
            <div class=\"subtext\" data-i18n=\"dash.compliance.sub_short\" style=\"margin:4px 0 0\">ISMS-P·ISO 27001 통제 점검 현황이에요. 미조치·기한초과부터 처리하면 돼요.</div>
            <details style=\"margin-top:6px\">
              <summary style=\"cursor:pointer;color:#3182f6;font-size:12px\" data-i18n=\"dash.pdca.criteria\">집계 기준 자세히</summary>
          ...
          <div class=\"mori-strip\" id=\"pdca_hero_counts\" style=\"display:none\"></div>
        </div>
      </section>

      <!-- PDCA Summary Cards -->
      <section class=\"metrics\" id=\"pdca_cards\">
        <div class=\"empty\" style=\"padding:16px;color:#191f28\" data-i18n=\"dash.status.pdca_loading\">PDCA 데이터를 불러오는 중…</div>
      </section>
      ...
      <section class=\"card\" id=\"soa_card\">
        ...
        <div id=\"soa_summary\" style=\"margin-top:8px;font-size:13px;color:#191f28\"></div>
      </section>
      ...
      <details class=\"card\" style=\"padding:0\">
        ...
        <section class=\"card\" id=\"control_tree_card\" style=\"margin:0 16px 12px\">
          ...
          <div id=\"audit_sample_box\" style=\"display:none;margin-top:8px;padding:10px 12px;background:#f7f8fa;border:1px solid #e5e8eb;border-radius:10px\"></div>
          <div id=\"gap_deadlines_box\" style=\"display:none;margin-top:8px;padding:10px 12px;background:#f7f8fa;border:1px solid #e5e8eb;border-radius:10px\"></div>
          <div id=\"change_report_box\" style=\"display:none;margin-top:8px;padding:10px 12px;background:#f7f8fa;border:1px solid #e5e8eb;border-radius:10px\"></div>
          ...
          <div id=\"ctl_admin_bar\" style=\"display:none;gap:8px;flex-wrap:wrap;align-items:center;margin:10px 0\">
            ...
            <span id=\"snap_msg\" style=\"font-size:11px;color:#191f28\"></span>
          </div>
          <div id=\"ctl_editor\" style=\"display:none;margin:8px 0;padding:12px;background:#f7f8fa;border:1px solid #e5e8eb;border-radius:10px\"></div>
          <div id=\"ctl_nlp\" style=\"display:none;margin:8px 0;padding:12px;background:#f7f8fa;border:1px solid #e5e8eb;border-radius:10px\"></div>
